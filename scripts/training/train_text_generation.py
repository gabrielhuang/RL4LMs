...
def main(config_path: str,
    ...
    # load tracker
    tracker = Tracker(base_path_to_store_results,
                      config,
                      project_name,
                      experiment_name,
                      entity_name,
    ...
    if "supervised" in config["alg"]["id"]:
        ...
        trainer = OnPolicyTrainer(tokenizer_config=config["tokenizer"],
                                  datapool_config=config["datapool"],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--entity_name", type=str,
                        ...
                        default=None)
    parser.add_argument("--base_path_to_store_results",
                        type=str, help="Base path to store experiment results",
                        default=os.getcwd())
